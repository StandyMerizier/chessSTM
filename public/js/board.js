//convenience function to get the index of piece
...
//creating gameboard
var GameBoard = {};
//everything to keep track of all the info going on on board
GameBoard.pieces = new Array(BRD_SQ_NUM);//size of square
GameBoard.side = COLOURS.WHITE;//user starts as white
GameBoard.fiftyMove = 0;//if both players reach 50 moves, they tie
GameBoard.hisPly = 0;//maintain half moves from one side, everymove is counted. so can take back moves.
GameBoard.history = [];
GameBoard.ply = 0;//number of half moves made in the search tree, lots of undo and doing
GameBoard.enPas = 0;//enpasson square, set if a square advance two square from starting square
GameBoard.castlePerm = 0;//make it able to castle king to rook
GameBoard.material = new Array(2); // WHITE,BLACK material of pieces
GameBoard.pceNum = new Array(13); // indexed by Pce
GameBoard.pList = new Array(14 * 10);//takes into the amoun tof the same pieces left
GameBoard.posKey = 0;//unique num describing position on board
