// constant integers, makes easier to debug and cleaner
var PIECES =  { EMPTY : 0, wP : 1, wN : 2, wB : 3,wR : 4, wQ : 5, wK : 6,
              bP : 7, bN : 8, bB : 9, bR : 10, bQ : 11, bK : 12  };

// size of board, numb of squares
var BRD_SQ_NUM = 120;

// defying files and ranks, rows and columns
...
//flip side makes it easier
var COLOURS = { WHITE:0, BLACK:1, BOTH:2 };

//male it so castle is possible
var CASTLEBIT = { WKCA : 1, WQCA : 2, BKCA : 4, BQCA : 8 };

//playing field and setting boundaries
var SQUARES = {
...
//for give file and rank, return board squared
function FR2SQ(f,r) {
 	return ( (21 + (f) ) + ( (r) * 10 ) );
}

//checking the piece value
...
//generate of random number, shift the first three to left
function RAND_32() {
